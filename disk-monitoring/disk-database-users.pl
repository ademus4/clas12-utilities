...
if (! $starting_directory || !$directory_label || !$password) {
    print_usage_message();
    exit 1;
}
...
$find_dir_command .= " -o -path /work/clas12/rg-d";
$find_dir_command .= " -o -path /work/clas12/rg-e";
$find_dir_command .= " -o -path /work/clas12/rg-f";
$find_dir_command .= " -o -path /work/clas12/rg-g";
$find_dir_command .= " -o -path /work/clas12/rg-h";
$find_dir_command .= " -o -path /work/clas12/rg-i";
$find_dir_command .= " -o -path /work/clas12/rg-j";
$find_dir_command .= " -o -path /work/clas12/rg-k";
$find_dir_command .= " -o -path /work/clas12/rg-l";
$find_dir_command .= " -o -path /work/clas12/rg-m";
$find_dir_command .= " -o -path /work/clas12/rg-n";
$find_dir_command .= " -o -path /work/clas12/rg-o";
$find_dir_command .= " -o -path /work/clas12/rg-p";
